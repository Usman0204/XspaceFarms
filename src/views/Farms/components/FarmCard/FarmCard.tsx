...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethPrice, account }) => {
  ...
  const lpLabel = farm.lpSymbol && farm.lpSymbol.toUpperCase().replace('XSD', '')
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'XSD'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'XSD' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
